...
function emailverify() {
    ...
    return (
        <div className='flex items-center justify-center min-h-screen px-6 sm:px-0 bg-gradient-to-br from-blue-800 to-sky-100'>
            <form onSubmit={onHnadelsubit} className='bg-state-900 p-8 rounded-lg shadow-lg w-96 text-sm'>
                ...
                <button className='w-full py-3 bg-gradient-to-r from-indigo-500 to-indigo-700 text-white rounded-full'>Verify Email</button>
            </form>
        </div>
    )
}
